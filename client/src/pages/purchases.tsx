...
export default function PurchasesPage({ onLogout }: PurchasesPageProps) {
  ...
  const {
    ...
    queryKey: [
      "https://api-pos.edpos.vn/api/purchase-receipts",
      {
        startDate,
        endDate,
        productFilter,
    ...
    queryFn: async () => {
      ...
      const url = `https://api-pos.edpos.vn/api/purchase-receipts?${params.toString()}`;
  ...
  const bulkDeleteMutation = useMutation({
    mutationFn: async (orderIds: number[]) => {
      return apiRequest("POST", "https://api-pos.edpos.vn/api/purchase-receipts/bulk-delete", {
        orderIds,
      });
    },
    onSuccess: (data) => {
