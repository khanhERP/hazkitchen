...
export default function InventoryPage({ onLogout }: InventoryPageProps) {
  ...
  const { data: productsResponse, isLoading: productsLoading } = useQuery({
    queryKey: ["https://api-pos.edpos.vn/api/products", { page: currentPage, limit: pageSize, searchTerm, selectedCategory, stockFilter }],
    queryFn: async () => {
      // Construct URL with query parameters
      const url = new URL("https://api-pos.edpos.vn/api/products", window.location.origin);
  ...
  const updateStockMutation = useMutation({
    mutationFn: async (data: StockUpdateForm) => {
      ...
      const response = await fetch("https://api-pos.edpos.vn/api/inventory/update-stock", {
        method: "POST",
        headers: {
    ...
    onSuccess: () => {
      ...
      queryClient.refetchQueries({ queryKey: ["https://api-pos.edpos.vn/api/products"] });
  ...
  const updateProductTrackInventoryMutation = useMutation({
    mutationFn: async ({
      ...
      const response = await fetch(`https://api-pos.edpos.vn/api/products/${id}/track-inventory`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteProductMutation = useMutation({
    mutationFn: async (productId: number) => {
      const response = await fetch(`https://api-pos.edpos.vn/api/products/${productId}`, {
        method: "DELETE",
      });
      if (!response.ok) {
  ...
  const cleanupMutation = useMutation({
    mutationFn: async () => {
      const response = await fetch("https://api-pos.edpos.vn/api/products/cleanup/inactive", {
        method: "DELETE",
      });
      if (!response.ok) {
