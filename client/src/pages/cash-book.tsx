...
export default function CashBookPage({ onLogout }: CashBookPageProps) {
  ...
  const { data: purchaseReceipts = [] } = useQuery({
    queryKey: ["https://edpos-be.onrender.com/api/purchase-receipts"],
    queryFn: async () => {
      try {
        const response = await fetch("https://edpos-be.onrender.com/api/purchase-receipts");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
  ...
  const { data: incomeVouchers = [] } = useQuery({
    queryKey: ["https://edpos-be.onrender.com/api/income-vouchers"],
    queryFn: async () => {
      try {
        const response = await fetch("https://edpos-be.onrender.com/api/income-vouchers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: expenseVouchers = [] } = useQuery({
    queryKey: ["https://edpos-be.onrender.com/api/expense-vouchers"],
    queryFn: async () => {
      try {
        const response = await fetch("https://edpos-be.onrender.com/api/expense-vouchers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: suppliers = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://edpos-be.onrender.com/api/suppliers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
