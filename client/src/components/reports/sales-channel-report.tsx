...
export function SalesChannelReport() {
  ...
  const { data: salesChannelSalesData, isLoading: salesLoading } = useQuery({
    queryKey: [
      "http://42.118.102.26:4500/api/sales-channel-sales",
      startDate,
      endDate,
      selectedSeller,
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`http://42.118.102.26:4500/api/sales-channel-sales?${params}`);
      if (!response.ok) {
  ...
  const { data: salesChannelProfitData, isLoading: profitLoading } = useQuery({
    queryKey: [
      "http://42.118.102.26:4500/api/sales-channel-profit",
      startDate,
      endDate,
      selectedSeller,
      selectedSalesChannel,
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`http://42.118.102.26:4500/api/sales-channel-profit?${params}`);
      if (!response.ok) {
  ...
  const { data: salesChannelProductsData, isLoading: productsLoading } =
    useQuery({
      queryKey: [
        "http://42.118.102.26:4500/api/sales-channel-products",
        startDate,
        endDate,
        selectedSeller,
        selectedSalesChannel,
      ...
      queryFn: async () => {
        ...
        const response = await fetch(`http://42.118.102.26:4500/api/sales-channel-products?${params}`);
        if (!response.ok) {
