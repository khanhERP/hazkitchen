...
function MenuReport() {
  ...
  const { data: categories = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://api-pos.edpos.vn/api/categories");
  ...
  const { data: products = [] } = useQuery({
    queryKey: ["https://api-pos.edpos.vn/api/products", selectedCategory, productType, productSearch],
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `https://api-pos.edpos.vn/api/products/${selectedCategory}/${productType}/${searchParam}`,
        );
  ...
  const {
    ...
    queryKey: ["https://api-pos.edpos.vn/api/menu-analysis", startDate, endDate, selectedCategory, productSearch],
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `https://api-pos.edpos.vn/api/menu-analysis?${params.toString()}`,
        );
        if (!response.ok) {
          console.error(
