...
function MenuReport() {
  ...
  const { data: categories = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://edpos-be.onrender.com/api/categories");
  ...
  const { data: products = [] } = useQuery({
    queryKey: ["https://edpos-be.onrender.com/api/products", selectedCategory, productType, productSearch],
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `https://edpos-be.onrender.com/api/products/${selectedCategory}/${productType}/${searchParam}`,
        );
  ...
  const {
    ...
    queryKey: ["https://edpos-be.onrender.com/api/menu-analysis", startDate, endDate, selectedCategory, productSearch],
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `https://edpos-be.onrender.com/api/menu-analysis?${params.toString()}`,
        );
        if (!response.ok) {
          console.error(
