...
export function CategoryStatsModal({ isOpen, onClose }: CategoryStatsModalProps) {
  ...
  const { data: productsData } = useQuery<any[]>({
    queryKey: ["https://edpos-be.onrender.com/api/products", { includeInactive: true }],
    queryFn: async () => {
      const response = await fetch("https://edpos-be.onrender.com/api/products?includeInactive=true");
