...
export function AttendanceList({ 
  ...
  const { data: attendanceRecords, isLoading } = useQuery({
    queryKey: useRange 
      ? ['https://api-pos.edpos.vn/api/attendance', 'range', dateRange?.startDate, dateRange?.endDate]
      : ['https://api-pos.edpos.vn/api/attendance', selectedDate],
    queryFn: async () => {
      let url = 'https://api-pos.edpos.vn/api/attendance';
