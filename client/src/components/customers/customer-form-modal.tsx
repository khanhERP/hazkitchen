...
export function CustomerFormModal({ isOpen, onClose, customer, initialPhone }: CustomerFormModalProps) {
  ...
  const generateCustomerId = async () => {
    try {
      ...
      console.error("Error generating customer "https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api error);
      return "CUST001";
    }
  };
  ...
  const createMutation = useMutation({
    ...
    onError: (error: any) => {"https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api
      toast({
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    let customerIdToUse = data.customerId;"https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api
