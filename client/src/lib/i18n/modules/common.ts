...
export const commonTranslations: { [key: string]: CommonTranslations } = {
  ko: {
    loading: "로딩 중...",
    minInvoiceAmount: "최소 결제 금액은 5,000 이상이어야 합니다",
    save: "저장",
    unpaid: "미결제",
    taxWithRate: "세금 ({rate}%)",
    pay: "결제",
    ...
    productUpdateSuccessDesc: "상품이 성공적으로 업데이트되었습니다",
    ...
    remotemanagerproduct:
      "비활성화된 모든 상품을 데이터베이스에서 영구적으로 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
    areyouremoteorder: "이 주문을 취소하시겠습니까?",
    loading: "로딩 중...",
    successTitle: "성공",
    confirm: "확인",
    yes: "예",
    ...
    selectImageFile: "이미지 파일을 선택하거나",
    dragDropUpload: "드래그엤드롭으로 업로드",
    searchProductPlaceholder: "이름 또는 SKU로 검색...",
    summary: "요약",
  },
  en: {
    save: "Save",
    transfer: "Transfer",
    minInvoiceAmount: "The minimum invoice amount must be at least 5,000",
    sku: "SKU",
    confirmDeleteVoucher: "Do you want to delete this voucher '{voucherNumber}'?",
    ...
    deleteCustomerWarning: "Warning: This action cannot be undone. All customer data will be permanently deleted.",
    deleteCustomerDetails: "This includes purchase history, membership points, and personal information.",
    cancelAction: "Cancel",
    ...
    search: "Search",
    filter: "Filter",
    areyouremoteorder: "Are you sure you want to cancel this order?",
    ...
    productUpdateSuccessDesc: "Product has been updated successfully",
  ...
  vi: {
    save: "Lưu",
    minInvoiceAmount: "Số tiền hóa đơn tối thiểu phải là 5,000",
    cancel: "Hủy",
    ...
    productUpdateSuccessDesc: "Sản phẩm đã được cập nhật thành công",
    ...
    confirmDeleteCustomerDesc: "Bạn có chắc chắn muốn xóa khách hàng '{name}'?",
    deleteCustomerWarning: "Cảnh báo: Hành động này không thể hoàn tác. Dữ liệu khách hàng sẽ bị xóa vĩnh viễn.",
    deleteCustomerDetails: "Bao gồm lịch sử mua hàng, điểm thành viên và thông tin cá nhân.",
    cancelAction: "Hủy",
    ...
    searchProductPlaceholder: "Tìm kiếm theo tên hoặc mã SKU...",
    summary: "Tóm tắt",
  },
};
