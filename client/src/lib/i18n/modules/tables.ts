...
export const tablesTranslations: { [key: string]: TablesTranslations } = {
  ...
  en: {
    ...
    skuAutoGenerate: "SKU (Auto-generated if left blank)",
    ...
    quantity: "Qty",
    amount: "Amount",
    allItemsSplit: "All items have been split",
    discount: "Discount",
    tax: "Tax",
    totalMoney: "Total",
    dishName: "Dish Name",
  ...
  vi: {
    ...
    addItems: "Gọi thêm",
    splitOrder: "Tách đơn",
    printBill: "In tạm tính",
    payWithPoints: "TT điểm",
    ...
    updatedProduct: "Sản phẩm đã được cập nhật",
    ...
    splitQuantity: "SL Tách",
    noItems: "Chưa có món nào",
    cancelAction: "Hủy bỏ",
    confirmAction: "Đồng ý",
    quantity: "SL",
    amount: "Số tiền",
    allItemsSplit: "Tất cả món đã được tách",
    discount: "Giảm giá",
    tax: "Thuế",
    totalMoney: "Tổng tiền",
    orderInfo: "Thông tin đơn hàng",
    orderCode: "Mã đơn",
    orderAmount: "Thành tiền",
